...
function insightsDataConverter( exportdata )
{
  ...
  function getEntityDetails( data )
  {
    ...
    teamOneForGame.primaryColor = data.metrics.entities[1].primaryColor;
    teamTwoForGame.primaryColor = data.metrics.entities[2].primaryColor;
    teamOneForGame.secondaryColor = data.metrics.entities[1].secondaryColor;
    teamTwoForGame.secondaryColor = data.metrics.entities[2].secondaryColor;
    teamOneForGame.metrics = data.metrics.entities[1].value.total;
    teamTwoForGame.metrics = data.metrics.entities[2].value.total;
    arr.teams.push(teamOneForGame);
    arr.teams.push(teamTwoForGame);
    return arr;
  }
  ...
  function createFinalEntity( data )
  {
    ...
    if ( data.type === 'games' )
    {
      ...
      {
        metricsForDate = getEntityDetails( data );
      }
    }
    else
    {
      formattedData.primaryColor = data.metrics.entities[0].primaryColor;
      formattedData.secondaryColor = data.metrics.entities[0].secondaryColor;
    }
