...
var epsup = require('app-server/signup/EmailPasswordSignupProcessor'),
    ssup = require('app-server/signup/SocialSignupProcessor');
 ...
 *   request, response, next:
 */
SignupProcessor.signupGoogle = function(request, response, next)
{
  signupSocial(
  {
    socialType: "google",
    extraAuthenticateParams: { callbackURL: '/signup/google/callback/' },
    errorMessage: 'We found a user linked to your Google account.'
  }, request, response, next);
};
