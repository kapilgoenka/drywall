...
exports = module.exports = function(app, passport)
{
  ...
  */
  ...
  app.get('/media-curation/savedQueries/:event', require('lib/app-server/MediaCuration').getSavedQueriesForEvent);
  app.post('/media-curation/savedQueries/:event', require('lib/app-server/MediaCuration').updateSavedQueriesForEvent);
  app.get('/media-curation/savedResults/:event', require('lib/app-server/MediaCuration').getAllSavedResultsForEvent);
  app.get('/media-curation/savedResults/:event/:resultName', require('lib/app-server/MediaCuration').getSavedResultWithNameForEvent);
  app.post('/media-curation/savedResults/:event/:resultName', require('lib/app-server/MediaCuration').updateSavedResultWithNameForEvent);
  app.get('/media-curation/:eventName/:property', require('lib/app-server/MediaCuration').getEventProperty);
  app.get('/media-curation/partner-specific-event-property/:eventName/:property', require('lib/app-server/MediaCuration').getPartnerSepecificEventProperty);
  app.get('/media-curation/:event', require('lib/app-server/MediaCuration').getEventConfigAndData);
