...
exports = module.exports = function(app, passport)
{
  ...
  app.post('/admin/organizations/:organization/:property', require('lib/app-server/admin/OrganizationAdmin').updatePartnerProperty);
  app.delete('/admin/organizations/:organization/:property', require('lib/app-server/admin/OrganizationAdmin').deletePartnerProperty);

  // admin > events
  app.get('/admin/events', require('lib/app-server/admin/EventAdmin').list);
  app.get('/admin/events/:event', require('lib/app-server/admin/EventAdmin').readEvent);
  app.post('/admin/events/:event', require('lib/app-server/admin/EventAdmin').createEvent);
  app.delete('/admin/events/:event', require('lib/app-server/admin/EventAdmin').deleteEvent);
  app.post('/admin/events/:event/:property', require('lib/app-server/admin/EventAdmin').updateEventProperty);
  app.get('/admin/events/:organization/:event', require('lib/app-server/admin/EventAdmin').readPartnerSpecificEvent);
  app.post('/admin/events/:organization/:event/:property', require('lib/app-server/admin/EventAdmin').updatePartnerSpecificEventProperty);
  app.delete('/admin/events/:event/:property', require('lib/app-server/admin/EventAdmin').deleteEventProperty);
  ...
  */
  ...
  app.get('/media-curation/savedQueries/:event', require('lib/app-server/api/media-curation/SavedQueries').getSavedQueriesForEvent);
  app.post('/media-curation/savedQueries/:event', require('lib/app-server/api/media-curation/SavedQueries').updateSavedQueriesForEvent);
  app.get('/media-curation/savedResults/:event', require('lib/app-server/api/media-curation/SavedResults').getAllSavedResultsForEvent);
  app.get('/media-curation/savedResults/:event/:resultName', require('lib/app-server/api/media-curation/SavedResults').getSavedResultWithNameForEvent);
  app.post('/media-curation/savedResults/:event/:resultName', require('lib/app-server/api/media-curation/SavedResults').updateSavedResultWithNameForEvent);
  app.delete('/media-curation/savedResults/:event/:resultName', require('lib/app-server/api/media-curation/SavedResults').deleteSavedResultWithNameForEvent);
  app.get('/media-curation/:eventName/:property', require('lib/app-server/api/media-curation/Events').getEventProperty);
  app.get('/media-curation/:event', require('lib/app-server/api/media-curation/Events').getEventConfigAndData);

  /*
    Data Export APIs
  */
  app.get('/dataExport/:username/:appId', require('lib/app-server/DataExport').getExportData);
  app.post('/dataExport/:username/:appId', require('lib/app-server/DataExport').updateExportData);
  app.delete('/dataExport/:username/:appId', require('lib/app-server/DataExport').deleteExportData);

  /*
    Account system <---> GK sync APIs
  */
  app.get('/user-mapping', require('lib/app-server/GKSync').getUserMapping);
  app.post('/user-mapping', require('lib/app-server/GKSync').updateUserMapping);
