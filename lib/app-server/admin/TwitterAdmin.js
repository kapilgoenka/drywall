...
//
var TwitterAdmin = module.exports;
 ...
 */
TwitterAdmin.find = function(request, response, next)
{
  // Defaults
  ...
  // Get results.
  request.app.db.models.TwitterAccount.pagedFind(
  {
    filters: filters,
//    keys: 'profile.id profile.name profile.screen_name',
  ...
  }, function(error, results)
  {
    ...
    {
      results.filters = request.query;
      return response.render('admin/twitter/index', { data: { results: JSON.stringify(results) } });
    }
  } );
};
 ...
 *   request, response, next:
 */
TwitterAdmin.read = function(request, response, next)
{
 ...
 *   request, response, next:
 */
TwitterAdmin.create = function(request, response, next)
{
  function validate()
  {
 ...
 *   request, response, next:
 */
TwitterAdmin.update = function(request, response, next)
{
  function validate()
  {
    // Defaults
 ...
 *   request, response, next:
 */
TwitterAdmin.updatePassword = function(request, response, next)
{
  function validate()
  {
 ...
 *   request, response, next:
 */
TwitterAdmin.linkAdmin = function(request, response, next)
{
  function validate()
  {
 ...
 *   request, response, next:
 */
TwitterAdmin.unlinkAdmin = function(request, response, next)
{
  function validate()
  {
    if (!request.user.roles.admin.isMemberOf('root'))
 ...
 *   request, response, next:
 */
TwitterAdmin.linkAccount = function(request, response, next)
{
  function validate()
  {
    if (!request.user.roles.admin.isMemberOf('root'))
 ...
 *   request, response, next:
 */
TwitterAdmin.unlinkAccount = function(request, response, next)
{
  function validate()
  {
    if (!request.user.roles.admin.isMemberOf('root'))
 ...
 *   request, response, next:
 */
TwitterAdmin.deleteUser = function(request, response, next)
{
  function validate()
  {
    if (!request.user.roles.admin.isMemberOf('root'))
